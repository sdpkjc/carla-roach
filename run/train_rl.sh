...
source /mnt/afs/user/zhaoyanxiao/miniconda3/bin/activate /mnt/afs/user/zhaoyanxiao/.conda/envs/roach

# source /mnt/afs/user/zhaoyanxiao/miniconda3/etc/profile.d/conda.sh
# conda activate /mnt/afs/user/xudongyang/.conda/envs/roach
